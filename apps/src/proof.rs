...
#[cfg(test)]
mod tests {
    use crate::gen::{Address, ContractData, Felt, GetProofResult, Node, StorageKey};

    #[test]
    fn valid_one_level_parse_proof() {
        let key = "0x0341c1bdfd89f69748aa00b5742b03adbffd79b8e80cab5c50d91cd8c2a79be1".to_string();
        let value = Felt::try_new("0x47616d65206f66204c69666520546f6b656e").unwrap();
    ...
    fn contract_state_hash_is_valid() {
        ...
        let expected = "0x30a3c317f49a18c65bb5d22c87172f3f60101d54425457a66237474dd2d66db";
        assert_eq!(
    ...
    fn calculate_global_root_is_valid() {
        let expected = "0x42e26eb87a82c4b4130cb6bfbd33be7788436aa66f787ede4aef9456b58939";
        assert_eq!(
    ...
    fn invalid_verify_contract_proof() {
        ...
        let contract_data = invalid_storage_proof.contract_data.as_ref().unwrap();
