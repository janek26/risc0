...
pub mod gen {
    ...
    mod chainid {
        ...
        static CHAINID_REGEX: Lazy<Regex> =
            Lazy::new(|| Regex::new("^0x[a-fA-F0-9]+$").expect("ChainId: valid regex"));
    ...
    mod deprecatedcontractclassprogram {
        ...
        static DEPRECATEDCONTRACTCLASSPROGRAM_REGEX: Lazy<Regex> = Lazy::new(|| {
            Regex::new("^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?$")
                .expect("DeprecatedContractClassProgram: valid regex")
        });
            ...
            pub fn try_new(value: &str) -> Result<Self, jsonrpc::Error> {
                if DEPRECATEDCONTRACTCLASSPROGRAM_REGEX.is_match(value) {
                    ...
                    Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "DeprecatedContractClassProgram value does not match regex: {value}"
                        ),
                    })
                }
            }
    ...
    mod ethaddress {
        ...
        static ETHADDRESS_REGEX: Lazy<Regex> =
            Lazy::new(|| Regex::new("^0x[a-fA-F0-9]{40}$").expect("EthAddress: valid regex"));
    ...
    mod numashex {
        ...
        static NUMASHEX_REGEX: Lazy<Regex> =
            Lazy::new(|| Regex::new("^0x[a-fA-F0-9]+$").expect("NumAsHex: valid regex"));
            ...
            pub fn try_new(value: i64) -> Result<Self, jsonrpc::Error> {
                if value < MIN {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "PendingBlockHeaderTimestamp value {value} must be > {MIN}"
                        ),
                    });
                }
                if value > MAX {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "PendingBlockHeaderTimestamp value {value} must be < {MAX}"
                        ),
                    });
                }
                Ok(Self(value))
            ...
            pub fn try_new(value: i64) -> Result<Self, jsonrpc::Error> {
                if value < MIN {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "ResultPageRequestChunkSize value {value} must be > {MIN}"
                        ),
                    });
                }
                if value > MAX {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "ResultPageRequestChunkSize value {value} must be < {MAX}"
                        ),
                    });
                }
                Ok(Self(value))
    ...
    mod storagekey {
        ...
        static STORAGEKEY_REGEX: Lazy<Regex> = Lazy::new(|| {
            Regex::new("^0x0[0-7]{1}[a-fA-F0-9]{0,62}$").expect("StorageKey: valid regex")
        });
        ...
        impl StructAbiEntrySize {
            pub fn try_new(value: i64) -> Result<Self, jsonrpc::Error> {
                if value < MIN {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!("StructAbiEntrySize value {value} must be > {MIN}"),
                    });
                }
                if value > MAX {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!("StructAbiEntrySize value {value} must be < {MAX}"),
                    });
                }
                Ok(Self(value))
            }
    ...
    mod u128 {
        ...
        static U128_REGEX: Lazy<Regex> = Lazy::new(|| {
            Regex::new("^0x(0|[a-fA-F1-9]{1}[a-fA-F0-9]{0,31})$").expect("U128: valid regex")
        });
        ...
        impl U128 {
            pub fn try_new(value: &str) -> Result<Self, jsonrpc::Error> {
                if U128_REGEX.is_match(value) {
                    ...
                    Err(jsonrpc::Error {
                        code: 1001,
                        message: format!("U128 value does not match regex: {value}"),
                    })
                }
            }
        }
    ...
    mod u64 {
        ...
        static U64_REGEX: Lazy<Regex> = Lazy::new(|| {
            Regex::new("^0x(0|[a-fA-F1-9]{1}[a-fA-F0-9]{0,15})$").expect("U64: valid regex")
        });
        ...
        impl U64 {
            pub fn try_new(value: &str) -> Result<Self, jsonrpc::Error> {
                if U64_REGEX.is_match(value) {
                    ...
                    Err(jsonrpc::Error {
                        code: 1001,
                        message: format!("U64 value does not match regex: {value}"),
                    })
                }
            }
        }
            ...
            pub fn try_new(value: i64) -> Result<Self, jsonrpc::Error> {
                if value < MIN {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "GetTransactionByBlockIdAndIndexIndex value {value} must be > {MIN}"
                        ),
                    });
                }
                if value > MAX {
                    return Err(jsonrpc::Error {
                        code: 1001,
                        message: format!(
                            "GetTransactionByBlockIdAndIndexIndex value {value} must be < {MAX}"
                        ),
                    });
                }
                Ok(Self(value))
    ...
    pub mod error {
        ...
        pub const CLASS_ALREADY_DECLARED: Error = Error(51, "Class already declared");
        ...
        pub const COMPILED_CLASS_HASH_MISMATCH: Error = Error(
            60,
        ...
        pub const INSUFFICIENT_MAX_FEE: Error = Error(
            53,
        ...
        pub const INVALID_TRANSACTION_NONCE: Error = Error(52, "Invalid transaction nonce");
        pub const INVALID_TXN_INDEX: Error = Error(27, "Invalid transaction index in a block");
        pub const NON_ACCOUNT: Error = Error(58, "Sender address in not an account contract");
        ...
        pub const PROOF_LIMIT_EXCEEDED: Error = Error(10000, "Too many storage keys requested");
        pub const TOO_MANY_KEYS_IN_FILTER: Error = Error(34, "Too many keys provided in a filter");
        pub const TRANSACTION_EXECUTION_ERROR: Error = Error(41, "Transaction execution error");
        pub const TXN_HASH_NOT_FOUND: Error = Error(29, "Transaction hash not found");
        pub const UNEXPECTED_ERROR: Error = Error(63, "An unexpected error occurred");
        ...
        pub const VALIDATION_FAILURE: Error = Error(55, "Account validation failed");
    ...
    pub trait Rpc {
        ...
        ) -> std::result::Result<GetTransactionByBlockIdAndIndexResult, jsonrpc::Error>;
        ...
        async fn syncing(&self) -> std::result::Result<SyncingResult, jsonrpc::Error>;
    ...
    async fn handle_getProof<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        ...
        let args = serde_json::from_value::<ArgByName>(params.clone()).or_else(|_| {
            serde_json::from_value::<ArgByPos>(params.clone()).map(|args_by_pos| {
                let ArgByPos(block_id, contract_address, keys) = args_by_pos;
                ArgByName {
                    block_id,
                    contract_address,
                    keys,
    ...
    async fn handle_getTxStatus<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_version<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_addInvokeTransaction<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_blockHashAndNumber<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_blockNumber<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_call<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_chainId<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_estimateFee<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(
            Vec<BroadcastedTxn>,
        ...
        let args = serde_json::from_value::<ArgByName>(params.clone()).or_else(|_| {
            serde_json::from_value::<ArgByPos>(params.clone()).map(|args_by_pos| {
                let ArgByPos(request, simulation_flags, block_id) = args_by_pos;
                ArgByName {
                    request,
                    simulation_flags,
                    block_id,
    ...
    async fn handle_estimateMessageFee<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_getBlockWithTxHashes<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(BlockId);
    ...
    async fn handle_getBlockWithTxs<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(BlockId);
    ...
    async fn handle_getClass<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_getClassAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_getClassHashAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(BlockId, Address);
    ...
    async fn handle_getEvents<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_getNonce<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(BlockId, Address);
    ...
    async fn handle_getStateUpdate<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(BlockId);
    ...
    async fn handle_getStorageAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
    ...
    async fn handle_getTransactionByHash<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(TxnHash);
    ...
    async fn handle_getTransactionStatus<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(TxnHash);
    ...
    async fn handle_simulateTransactions<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        ...
        let args = serde_json::from_value::<ArgByName>(params.clone()).or_else(|_| {
            serde_json::from_value::<ArgByPos>(params.clone()).map(|args_by_pos| {
                let ArgByPos(block_id, transactions, simulation_flags) = args_by_pos;
                ArgByName {
                    block_id,
                    transactions,
                    simulation_flags,
    ...
    async fn handle_specVersion<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_syncing<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
    ...
    async fn handle_traceTransaction<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
        #[derive(Deserialize, Serialize)]
        struct ArgByPos(TxnHash);
    ...
    pub async fn handle<RPC: Rpc>(rpc: &RPC, req: &jsonrpc::Request) -> jsonrpc::Response {
        ...
        let response = match req.method.as_str() {
            ...
            "starknet_addDeclareTransaction" => handle_addDeclareTransaction(rpc, params).await,
            "starknet_addDeployAccountTransaction" => {
                handle_addDeployAccountTransaction(rpc, params).await
            }
            "starknet_addInvokeTransaction" => handle_addInvokeTransaction(rpc, params).await,
            "starknet_blockHashAndNumber" => handle_blockHashAndNumber(rpc, params).await,
            ...
            "starknet_estimateMessageFee" => handle_estimateMessageFee(rpc, params).await,
            "starknet_getBlockTransactionCount" => {
                handle_getBlockTransactionCount(rpc, params).await
            }
            "starknet_getBlockWithTxHashes" => handle_getBlockWithTxHashes(rpc, params).await,
            "starknet_getBlockWithTxs" => handle_getBlockWithTxs(rpc, params).await,
            "starknet_getClass" => handle_getClass(rpc, params).await,
            "starknet_getClassAt" => handle_getClassAt(rpc, params).await,
            "starknet_getClassHashAt" => handle_getClassHashAt(rpc, params).await,
            "starknet_getEvents" => handle_getEvents(rpc, params).await,
            "starknet_getNonce" => handle_getNonce(rpc, params).await,
            "starknet_getStateUpdate" => handle_getStateUpdate(rpc, params).await,
            ...
            "starknet_getTransactionByHash" => handle_getTransactionByHash(rpc, params).await,
            "starknet_getTransactionReceipt" => handle_getTransactionReceipt(rpc, params).await,
            "starknet_getTransactionStatus" => handle_getTransactionStatus(rpc, params).await,
            "starknet_simulateTransactions" => handle_simulateTransactions(rpc, params).await,
            "starknet_specVersion" => handle_specVersion(rpc, params).await,
            "starknet_syncing" => handle_syncing(rpc, params).await,
            "starknet_traceBlockTransactions" => handle_traceBlockTransactions(rpc, params).await,
            "starknet_traceTransaction" => handle_traceTransaction(rpc, params).await,
    ...
    pub mod blocking {
        ...
        pub trait Rpc {
            ...
            /// Returns an object about the sync status, or false if the node is not syncing
            fn syncing(&self) -> std::result::Result<SyncingResult, jsonrpc::Error>;
        ...
        fn handle_getProof<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Address, Vec<StorageKey>);
        ...
        fn handle_getTxStatus<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(TxnHash);
        ...
        fn handle_version<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
            match rpc.version() {
                Ok(ret) => match serde_json::to_value(ret) {
                    Ok(ret) => jsonrpc::Response::result(ret),
                    Err(e) => jsonrpc::Response::error(1003, &format!("{e:?}")),
        ...
        fn handle_addDeclareTransaction<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BroadcastedDeclareTxn);
        ...
        fn handle_addInvokeTransaction<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BroadcastedInvokeTxn);
        ...
        fn handle_blockHashAndNumber<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
        ...
        fn handle_blockNumber<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
        ...
        fn handle_chainId<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
            match rpc.chainId() {
                Ok(ret) => match serde_json::to_value(ret) {
                    Ok(ret) => jsonrpc::Response::result(ret),
                    Err(e) => jsonrpc::Response::error(1003, &format!("{e:?}")),
        ...
        fn handle_estimateFee<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(
                Vec<BroadcastedTxn>,
                Vec<SimulationFlagForEstimateFee>,
        ...
        fn handle_estimateMessageFee<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(MsgFromL1, BlockId);
        ...
        fn handle_getBlockWithTxHashes<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId);
        ...
        fn handle_getBlockWithTxs<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId);
        ...
        fn handle_getClass<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Felt);
        ...
        fn handle_getClassAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Address);
        ...
        fn handle_getClassHashAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Address);
        ...
        fn handle_getEvents<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(GetEventsFilter);
        ...
        fn handle_getNonce<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Address);
        ...
        fn handle_getStateUpdate<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId);
        ...
        fn handle_getStorageAt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(Address, StorageKey, BlockId);
        ...
        fn handle_getTransactionByHash<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(TxnHash);
        ...
        fn handle_getTransactionReceipt<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(TxnHash);
        ...
        fn handle_getTransactionStatus<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(TxnHash);
        ...
        fn handle_simulateTransactions<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId, Vec<BroadcastedTxn>, Vec<SimulationFlag>);
        ...
        fn handle_specVersion<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
        ...
        fn handle_syncing<RPC: Rpc>(rpc: &RPC, _params: &Value) -> jsonrpc::Response {
            match rpc.syncing() {
                Ok(ret) => match serde_json::to_value(ret) {
                    Ok(ret) => jsonrpc::Response::result(ret),
                    Err(e) => jsonrpc::Response::error(1003, &format!("{e:?}")),
        ...
        fn handle_traceBlockTransactions<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(BlockId);
        ...
        fn handle_traceTransaction<RPC: Rpc>(rpc: &RPC, params: &Value) -> jsonrpc::Response {
            #[derive(Deserialize, Serialize)]
            struct ArgByPos(TxnHash);
        ...
        pub fn handle<RPC: Rpc>(rpc: &RPC, req: &jsonrpc::Request) -> jsonrpc::Response {
            ...
            let response = match req.method.as_str() {
                ...
                "starknet_addDeclareTransaction" => handle_addDeclareTransaction(rpc, params),
                "starknet_addDeployAccountTransaction" => {
                    handle_addDeployAccountTransaction(rpc, params)
                }
                "starknet_addInvokeTransaction" => handle_addInvokeTransaction(rpc, params),
                "starknet_blockHashAndNumber" => handle_blockHashAndNumber(rpc, params),
                ...
                "starknet_estimateMessageFee" => handle_estimateMessageFee(rpc, params),
                "starknet_getBlockTransactionCount" => handle_getBlockTransactionCount(rpc, params),
                "starknet_getBlockWithTxHashes" => handle_getBlockWithTxHashes(rpc, params),
                ...
                "starknet_getTransactionByHash" => handle_getTransactionByHash(rpc, params),
                "starknet_getTransactionReceipt" => handle_getTransactionReceipt(rpc, params),
                "starknet_getTransactionStatus" => handle_getTransactionStatus(rpc, params),
                "starknet_simulateTransactions" => handle_simulateTransactions(rpc, params),
                "starknet_specVersion" => handle_specVersion(rpc, params),
                "starknet_syncing" => handle_syncing(rpc, params),
                "starknet_traceBlockTransactions" => handle_traceBlockTransactions(rpc, params),
    ...
    pub mod client {
        ...
        impl super::Rpc for Client {
            async fn getProof(
                ...
                let req = jsonrpc::Request::new("pathfinder_getProof".to_string(), params)
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetProofResult = serde_json::from_value(value).map_err(|e| {
            ...
            async fn getTxStatus(
                ...
                let params: serde_json::Value = serde_json::to_value(args)
                    .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                let req = jsonrpc::Request::new("pathfinder_getTxStatus".to_string(), params)
                    .with_id(jsonrpc::Id::Number(1));
                ...
                if let Some(value) = res.result.take() {
                    let ret: TxGatewayStatus = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn version(&self) -> std::result::Result<String, jsonrpc::Error> {
                ...
                if let Some(value) = res.result.take() {
                    let ret: String = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            ) -> std::result::Result<AddDeployAccountTransactionResult, jsonrpc::Error>
            {
                ...
                if let Some(value) = res.result.take() {
                    let ret: AddDeployAccountTransactionResult = serde_json::from_value(value)
                        .map_err(|e| {
                            jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                        })?;
            ...
            async fn blockNumber(&self) -> std::result::Result<BlockNumber, jsonrpc::Error> {
                ...
                if let Some(value) = res.result.take() {
                    let ret: BlockNumber = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn call(
                ...
                if let Some(value) = res.result.take() {
                    let ret: Vec<Felt> = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn chainId(&self) -> std::result::Result<ChainId, jsonrpc::Error> {
                ...
                if let Some(value) = res.result.take() {
                    let ret: ChainId = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn estimateFee(
                ...
                if let Some(value) = res.result.take() {
                    let ret: Vec<FeeEstimate> = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn estimateMessageFee(
                ...
                let params: serde_json::Value = serde_json::to_value(args)
                    .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                let req = jsonrpc::Request::new("starknet_estimateMessageFee".to_string(), params)
                    .with_id(jsonrpc::Id::Number(1));
                ...
                if let Some(value) = res.result.take() {
                    let ret: FeeEstimate = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn getBlockTransactionCount(
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetBlockTransactionCountResult = serde_json::from_value(value)
                        .map_err(|e| {
                            jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                        })?;
            ...
            async fn getClass(
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetClassResult = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn getClassAt(
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetClassAtResult = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn getClassHashAt(
                ...
                if let Some(value) = res.result.take() {
                    let ret: Felt = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn getEvents(
                ...
                if let Some(value) = res.result.take() {
                    let ret: EventsChunk = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn getStateUpdate(
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetStateUpdateResult = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            ) -> std::result::Result<GetTransactionByBlockIdAndIndexResult, jsonrpc::Error>
            {
                ...
                if let Some(value) = res.result.take() {
                    let ret: GetTransactionByBlockIdAndIndexResult = serde_json::from_value(value)
                        .map_err(|e| {
                            jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                        })?;
            ...
            async fn getTransactionStatus(
                ...
                let params: serde_json::Value = serde_json::to_value(args)
                    .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                let req =
                    jsonrpc::Request::new("starknet_getTransactionStatus".to_string(), params)
                        .with_id(jsonrpc::Id::Number(1));
            ...
            async fn simulateTransactions(
                ...
                let params: serde_json::Value = serde_json::to_value(args)
                    .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                let req =
                    jsonrpc::Request::new("starknet_simulateTransactions".to_string(), params)
                        .with_id(jsonrpc::Id::Number(1));
            ...
            async fn syncing(&self) -> std::result::Result<SyncingResult, jsonrpc::Error> {
                ...
                if let Some(value) = res.result.take() {
                    let ret: SyncingResult = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
            ...
            async fn traceTransaction(
                ...
                if let Some(value) = res.result.take() {
                    let ret: TransactionTrace = serde_json::from_value(value).map_err(|e| {
                        jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                    })?;
        ...
        pub mod blocking {
            ...
            impl super::super::blocking::Rpc for Client {
                ...
                ) -> std::result::Result<AddDeclareTransactionResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: AddDeclareTransactionResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<AddInvokeTransactionResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: AddInvokeTransactionResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                fn estimateMessageFee(
                    ...
                    let params: serde_json::Value = serde_json::to_value(args)
                        .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                    let req =
                        jsonrpc::Request::new("starknet_estimateMessageFee".to_string(), params)
                            .with_id(jsonrpc::Id::Number(1));
                ...
                ) -> std::result::Result<GetBlockWithTxHashesResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: GetBlockWithTxHashesResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<GetTransactionByHashResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: GetTransactionByHashResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<GetTransactionReceiptResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: GetTransactionReceiptResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<GetTransactionStatusResult, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: GetTransactionStatusResult = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<Vec<SimulatedTransaction>, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: Vec<SimulatedTransaction> = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                ) -> std::result::Result<Vec<BlockTransactionTrace>, jsonrpc::Error>
                {
                    ...
                    if let Some(value) = res.result.take() {
                        let ret: Vec<BlockTransactionTrace> = serde_json::from_value(value)
                            .map_err(|e| {
                                jsonrpc::Error::new(5002, format!("Invalid response object: {e}."))
                            })?;
                ...
                fn traceTransaction(
                    ...
                    let params: serde_json::Value = serde_json::to_value(args)
                        .map_err(|e| jsonrpc::Error::new(4001, format!("Invalid params: {e}.")))?;
                    let req =
                        jsonrpc::Request::new("starknet_traceTransaction".to_string(), params)
                            .with_id(jsonrpc::Id::Number(1));
